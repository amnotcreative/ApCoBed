...
function PoliceRegister() {
    const registerPoliceNameRef = useRef()
    ...
    async function handleRegister(e) {
        ...
        if(registerPasswordRef.current.value.length < 5)
        {
            ...
            setregistererror("")
            setLoading(true)
            await registerPolice(registerEmailRef.current.value, registerPasswordRef.current.value, registerPoliceNameRef.current.value).then((data)=>{
                ...
                <Col xs={12} lg={6} className="d-flex justify-content-center flex-column">
                    ...
                    <Form className="login-form" onSubmit={handleRegister}>
                        <Form.Group controlId="name">
                            ...
                            <Form.Control type="text" placeholder="Enter name" ref={registerPoliceNameRef} required />
                        </Form.Group>
                        <Form.Group controlId="registerEmail">
                            <Form.Label>Police Email address</Form.Label>
